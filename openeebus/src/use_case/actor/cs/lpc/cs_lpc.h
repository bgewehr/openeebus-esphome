 ...
 * @return kEebusErrorOk on success, error code otherwise
 */
static inline EebusError CsLpcSetActiveConsumptionPowerLimit(
 ...
 * @return kEebusErrorOk on success, error code otherwise
 */
static inline EebusError CsLpcGetFailsafeConsumptionActivePowerLimit(
 ...
 * @return kEebusErrorOk on success, error code otherwise
 */
static inline EebusError CsLpcSetFailsafeConsumptionActivePowerLimit(
    CsLpUseCaseObject* self,
